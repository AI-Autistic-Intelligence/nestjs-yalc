    ...
    let SkeletonUserService = class SkeletonUserService extends generic_service_js_1.GenericService {
        ...
        async resetPassword(guid) {
            const newPass = Array(12)
                ...
                .join('');
            await this.getRepositoryWrite().update({ guid }, { password: (0, returnValue_js_1.default)(newPass) });
            return newPass;
        }
    };
    SkeletonUserService = __decorate([
        (0, common_1.Injectable)(),
        __param(0, (0, typeorm_1.InjectRepository)(skeleton_user_entity_js_1.SkeletonUser, dbConnection)),
        __metadata("design:paramtypes", [generic_repository_js_1.GenericTypeORMRepository])
    ], SkeletonUserService);
    return SkeletonUserService;
};
exports.skeletonUserServiceFactory = skeletonUserServiceFactory;
//# sourceMappingURL=skeleton-user.service.js.map