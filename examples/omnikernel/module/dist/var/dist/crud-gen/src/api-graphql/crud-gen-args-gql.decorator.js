...
const CrudGenArgs = (params) => {
    ...
    if (!gqlOptions.type) {
        gqlOptions.type = (0, returnValue_1.default)((0, crud_gen_args_js_1.crudGenParamsFactory)(params.defaultValue, params.entityType));
    }
...
const CrudGenArgsNoPagination = (params) => {
    const gqlOptions = params.gql ?? {};
    if (!gqlOptions.type) {
        gqlOptions.type = (0, returnValue_1.default)((0, crud_gen_args_js_1.crudGenParamsNoPaginationFactory)(params.defaultValue, params.entityType));
    }
    params.gql = gqlOptions;
    return (0, exports.CrudGenCombineDecorators)(params);
};
