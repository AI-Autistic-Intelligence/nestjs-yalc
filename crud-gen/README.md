...
- Documentation index:
  https://github.com/Nek97/nestjs-yalc/blob/dev/docs/documentation.md
- GraphQL CRUD guide:
  https://github.com/Nek97/nestjs-yalc/blob/dev/docs/api-creation.md
- Modeling with `ModelObject` and `ModelField`:
  https://github.com/Nek97/nestjs-yalc/blob/dev/docs/crud-gen-modeling.md
- Dependency factory options:
  https://github.com/Nek97/nestjs-yalc/blob/dev/docs/crud-gen-factory.md
- REST usage:
  https://github.com/Nek97/nestjs-yalc/blob/dev/docs/crud-gen-rest.md
