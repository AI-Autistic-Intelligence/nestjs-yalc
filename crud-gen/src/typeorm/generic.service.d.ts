...
import { type CrudGenRepositoryCapabilities, type GenericTypeORMRepository } from '@nestjs-yalc/crud-gen/typeorm/generic.repository.js';
import { CrudGenFindManyOptions, ICrudGenSimpleParams } from '@nestjs-yalc/crud-gen/api-graphql/crud-gen-gql.interface.js';
