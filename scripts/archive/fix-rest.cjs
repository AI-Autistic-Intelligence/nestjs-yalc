...
const files = [
  ...
  { p: 'crud-gen/src/__tests__/generic-resolver.spec.ts', find: /import \* as ([a-zA-Z0-9_]+) from '@nest-yalc-2\/ag-grid\/ag-grid-metadata\.helper';/, mod: '@nest-yalc-2/ag-grid/ag-grid-metadata.helper.js' },
