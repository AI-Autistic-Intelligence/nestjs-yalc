...
const files = [
  ...
  { p: 'ag-grid/src/__tests__/gqlfields.decorator.spec.ts', find: /import \* as ([a-zA-Z0-9_]+) from '@nestjs-yalc\/crud-gen\/crud-gen\.helpers\.js';/, mod: '@nestjs-yalc/crud-gen/crud-gen.helpers.js' },
