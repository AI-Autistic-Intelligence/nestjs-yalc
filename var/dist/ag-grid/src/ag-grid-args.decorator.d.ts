...
export declare function getDateFilter(filter: string, firstParameter: string, secondParameter?: string): FindOperator<any>;
...
export declare const AgGridArgsMapper: <T>(...dataOrPipes: any[]) => ParameterDecorator;
...
export declare const AgGridArgsSingleDecorator: <T>(...dataOrPipes: any[]) => ParameterDecorator;
