import { QueryBuilderHelper, ReplicationMode, } from '@nestjs-yalc/database/query-builder.helper';
...
export class AgGridRepository extends Repository {
    ...
    async getOneAgGrid(findOptions, withFail, mode = ReplicationMode.SLAVE) {
