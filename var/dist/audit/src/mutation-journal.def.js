export const MUTATION_JOURNAL_OPTIONS = Symbol('nestjs-yalc:mutation-journal:options');
export const MUTATION_JOURNAL_DRIVERS = Symbol('nestjs-yalc:mutation-journal:drivers');
