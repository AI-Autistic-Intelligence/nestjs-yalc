...
const jest_def_config_ts_1 = tslib_1.__importStar(require("./jest-def.config.js"));
...
function jestConfGenerator(rootPath, projectList, appProjectsSettings, options) {
    ...
    const confFactory = (projName, proj, projects) => ({
        ...(0, jest_def_config_ts_1.default)(`${rootPath}/`, options.defaultConfOptions, (0, jest_def_config_ts_1.tsJestConfig)(options.tsConfigPath?.(proj) ??
            `${rootPath}/${proj.path}/tsconfig.${proj.type === 'library' ? 'lib' : 'app'}.json`, options.tsJestConfig)),
        globals: (0, jest_def_config_ts_1.globals)(),
        ...
        coverageThreshold: (0, jest_def_config_ts_1.coverageThreshold)(projects, options.defaultCoverageThreshold),
        coveragePathIgnorePatterns: jest_def_config_ts_1.coveragePathIgnorePatterns,
    });
...
const createE2EConfig = (options) => {
    let conf = {
        ...(0, jest_def_config_ts_1.default)(`${options.rootDirname}`, options.defaultConfOptions, (0, jest_def_config_ts_1.tsJestConfigE2E)(path.resolve(`${options.e2eDirname}/tsconfig.json`), options.withGqlPlugins ?? false, options.tsJestConfig)),
