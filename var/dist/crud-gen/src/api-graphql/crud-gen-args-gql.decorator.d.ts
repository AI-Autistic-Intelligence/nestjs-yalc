...
export declare const CrudGenArgsSingleDecorator: <T extends ObjectLiteral>(...dataOrPipes: (ICrudGenGqlArgsOptions | import("@nestjs/common").PipeTransform<any, any> | import("@nestjs/common").Type<import("@nestjs/common").PipeTransform<any, any>> | undefined)[]) => ParameterDecorator;
