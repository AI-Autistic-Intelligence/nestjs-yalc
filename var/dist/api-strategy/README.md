...
- API Strategy guide:
  https://github.com/Nek97/nestjs-yalc/blob/dev/docs/api-strategy.md
- API Strategy and EventManager patterns:
  https://github.com/Nek97/nestjs-yalc/blob/dev/docs/api-strategy-event-manager-patterns.md
