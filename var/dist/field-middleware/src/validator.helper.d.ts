...
export declare function stringIsInEnumOrThrow<T extends Record<string, unknown>>(toCheck: string, enumName: T, message?: string): true | void;
export declare function stringIsInEnum<T extends Record<string, unknown>>(toCheck: string, enumName: T): boolean;
