...
export type MutationJournalSkipReason = 'excluded' | 'blob-column' | 'virtual-table' | 'too-many-columns';
...
export interface IMutationJournalDriver {
    ...
    uninstall(dataSource: DataSource, options: MutationJournalDriverInstallOptions): Promise<void>;
