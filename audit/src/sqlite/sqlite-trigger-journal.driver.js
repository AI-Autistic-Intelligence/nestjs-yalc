...
class SqliteTriggerJournalDriver {
    ...
    async cleanup(dataSource, options, olderThanMs) {
        ...
        try {
            ...
            return (_b = (_a = rows[0]) === null || _a === void 0 ? void 0 : _a.changes) !== null && _b !== void 0 ? _b : 0;
        }
        finally {
            await queryRunner.release();
        }
    ...
    async read(dataSource, options, filter) {
        ...
        try {
            ...
            const limit = (_a = filter.limit) !== null && _a !== void 0 ? _a : mutation_journal_def_js_1.DEFAULT_READ_LIMIT;
    ...
    getTableSkipReason(table, options) {
        ...
        if (/^CREATE VIRTUAL TABLE/i.test((_a = table.sql) !== null && _a !== void 0 ? _a : '')) {
    ...
    getColumnSkipReason(columns) {
        ...
        if (columns.some((column) => { var _a; return !((_a = column.type) === null || _a === void 0 ? void 0 : _a.trim()) || /BLOB/i.test(column.type); })) {
            return 'blob-column';
        }
        return undefined;
    }
